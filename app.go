...
func walker(realPath string, f os.FileInfo, err error) error {
	...
	if f.IsDir() {
		...
		fmt.Println("\t[FILE]\t「"+f.Name()+"」@『"+relPath+"』\t|\t"+realPath, strconv.FormatInt(f.Size(), 10)+" Bytes")
...
func main() {
	...
	versionStr := "// Generated by https://github.com/Nigh/picture-to-array\n// Version:" + Version + "\n"
